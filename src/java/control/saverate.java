 ...
 * @author egypt2
 */
@WebServlet(name = "saverate", urlPatterns = {"/saverate"})
public class saverate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String curid=request.getParameter("c");
            ...
            int cur=Integer.parseInt(curid);
            System.out.print("////////////////////////////////  "+rr+" "+idd+" "+cur+" "+c.get_name());
            productinsystem k=new productinsystem();
            k.updaterate(idd,rr,cur);
            k.addcomment(com,idd,c.get_name());
