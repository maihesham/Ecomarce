...
public final class reg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Rigestration as customer</title>\n");
      ...
      out.write("                       <form action=\"saveuserasnotverify\" method=\"Post\">\n");
      out.write("                            <div class=\"form-group\">\n");
      out.write("                              <label>Name</label>\n");
      out.write("                              <input type=\"text\" name=\"name\" onblur=\"sendajax()\"   required class=\"form-control\" id=\"name\" placeholder=\"Enter Name\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"form-group\">\n");
      out.write("                              <label>Phone</label>\n");
      out.write("                              <input  name =\"phone\" required type=\"number\"  class=\"form-control\" id=\"phone\" placeholder=\"Enter phone\">\n");
      out.write("                            </div>\n");
      out.write("                           <div class=\"form-group\">\n");
      out.write("                              <label >Password</label>\n");
      out.write("                              <input type=\"password\" name=\"pass\"  required pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{6,}\"  class=\"form-control\" id=\"pass\" placeholder=\"Enter Password\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"form-group\">\n");
      out.write("                              <label>E-mail</label>\n");
      out.write("                              <input type=\"email\"  name=\"email\" required class=\"form-control\" id=\"email\" placeholder=\"Enter E-mail\">\n");
      out.write("                            </div>\n");
      out.write("                           \n");
      out.write("                             <div class=\"form-group\">\n");
      out.write("                              <label>Address</label>\n");
      out.write("                              <input type=\"text\" name=\"address\" required class=\"form-control\" id=\"addres\" placeholder=\"Enter Address\">\n");
      out.write("                            </div>\n");
      out.write("                           <div class=\"form-group\">\n");
      out.write("                              <label>Country</label>\n");
      out.write("                              \n");
      out.write("                              <div class=\"custom-select\"  >\n");
      out.write("                                  <select style=\"width:550px; height: 30px; border-radius: 5px; border:1px solid #ccc; \" >\n");
      out.write("                                        <option value=\"Eygpt\" selected>Eygpt</option>\n");
